  ...
  module ConstructFlow
    module DoorWindow
      class InstanceDefinition
        ...
        attr_reader :type_id, :opening_object_id, :handing, :schedule_mark

        def initialize(type_id:, opening_object_id:, handing: 'default', schedule_mark: nil)
        ...
        def with(type_id: self.type_id, opening_object_id: self.opening_object_id,
                 handing: self.handing, schedule_mark: self.schedule_mark)
          self.class.new(
            type_id: type_id,
